  ...
  return (
    <>
            ...
            >
              <div className="absolute w-full h-full">
                <div className="flex justify-center items-center h-full flex-col">
                  ...
                  <p className="mb-48 text-3xl md:text-4xl font-semibold tracking-tight">
                    시장275에서 만나보세요!
                  </p>
                </div>
              </div>
      ...
      <div className="swiper-navigation">
        <button className="swiper-button-prev main-btn-prev w-10" onClick={handlePrevClick}>
          <img src={`${HOME_PATH}/img/prev_arrow.png`} alt="Previous"/>
        </button>

        <button className="swiper-button-next main-btn-next w-10" onClick={handleNextClick}>
